        ...
        <div className="detailed-terms-jang-head">
          ...
          <div className="detailed-terms-jo" id="section3">
            <p>
              ...
              <br />
              회사는 약관의 개정이 필요할 경우, 관련 법령에 따라 약관을 개정할
              수 있습니다. 변경 사항은 ...
            </p>
          </div>
        ...
        <div className="detailed-terms-jang">
          ...
          <div className="detailed-terms-jo-head" id="section5">
            <p>
              ...
              회원가입을 신청할 수 있으며, 회사는 이를 승인하여 이용계약이
              체결됩니다.
            </p>
          </div>
          <div className="detailed-terms-jo" id="section6">
            <p>
              ...
              <br />
              기본적인 서비스는 무료로 제공되나, 특정 유료 서비스의 경우
              이용요금이 발생할 수 있습니다.
            </p>
          </div>
          <div className="detailed-terms-jo" id="section7">
            <p>
              ...
              <br />
              회사는 서비스 제공을 위하여 이용자의 개인정보를 수집할 수 있으며,
          ...
          <div className="detailed-terms-jo" id="section8">
            <p>
              ...
              <br />
              이용자는 자신의 ID와 비밀번호 관리에 대한 책임이 있으며, 이를
          ...
          <div className="detailed-terms-jo" id="section9">
            <p>
              ...
              <br />
              회사는 정기점검, 기술적 문제 등이 발생하는 경우 서비스 제공을
              일시적으로 중단할 수 있습니다.
            </p>
          </div>
        </div>
        ...
        <div className="detailed-terms-jang">
          ...
          <div className="detailed-terms-jo-head" id="section10">
            <p>
              ...
              <br />
              이용자는 본 약관 및 회사의 운영 방침을 준수하여야 하며, 불법
              행위를 하지 않아야 합니다.
            </p>
          </div>
          <div className="detailed-terms-jo" id="section11">
            <p>
              ...
              <br />
              회사가 제공하는 콘텐츠의 저작권은 회사에 있으며, 이용자는 이를
              무단으로 복제, 배포할 수 없습니다.
            </p>
          </div>
          <div className="detailed-terms-jo" id="section12">
            <p>
              ...
              <br />
              회사는 일정한 사유가 발생할 경우, 서비스의 제공을 일시 중단할 수
              있으며, 이 경우 사전 공지를 하여야 합니다.
            </p>
          </div>
        </div>
