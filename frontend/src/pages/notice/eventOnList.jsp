...
<body>
	...
	<div className="event-section">
		<div className="tab-header">
			<a className="active" href="/eventOnList">진행중 이벤트</a>
			<a href="/eventOffList">종료된 이벤트</a>
		</div>
		<div className="category-tabs">
			<button onClick = "location.href='/eventOnList'" className="${empty param.category ? 'active' : ''}">전체</button>
			<button onClick = "location.href='/eventOnList?category=할인'" className="${param.category == '할인' ? 'active' : ''}">할인</button>
			<button onClick = "location.href='/eventOnList?category=포인트'" className="${param.category == '포인트'? 'active' : ''}">포인트</button>
			<button onClick = "location.href='/eventOnList?category=기타'" className="${param.category == '기타'? 'active' : ''}">기타</button>
		</div>
