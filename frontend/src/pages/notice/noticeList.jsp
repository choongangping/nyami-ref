...
<body>
	...
	<nav className="navbar-menu">
        <a href="/noticeList" className="menu-item active">공지사항</a>
        <a href="/eventOnList" className="menu-item">이벤트</a>
    </nav>
    ...
    <div className="container">
        ...
        <div className="search-bar">
        	<form action="/noticeList" method="get">
        		<select name="searchType" className="searchType-input">
	            ...
	            <input type="text" name="searchKeyword" placeholder="검색어를 입력하세요." value="${noticePageResponse.searchKeyword}" className="search-input">
		...
		<c:forEach var = "notice" items = "${noticePageResponse.list}">
			<div className="notice-item">
                ...
                <a href="/notice/${notice.id}" className="notice-title">${notice.title}</a>
