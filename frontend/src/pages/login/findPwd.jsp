  ...
  <body>
    <div className="findpwd-form-container">
      <div className="findpwd-header">
        <h1 className="findpwd-logo">비밀번호 찾기</h1>
      </div>

      <div className="findpwd-form">
        <p className="instruction-text">찾고자 하는 아이디와 비밀번호를 받을 이메일 주소를 입력하세요.</p>
      ...
      <input type="button" className="signcomplete" id="findPwd-btn" value="비밀번호 찾기" />
