        ...
        <div className="detailed-terms-jang-head">
          ...
          <div className="detailed-terms-jo-head" id="section1">
            <p>
              ...
              <br />이 약관은 외식 추천 서비스의 이용과 관련하여 서비스 제공자와 이용자의 권리, 의무 및 책임을 규정함을 목적으로 합니다.
            </p>
          </div>
          ...
          <div className="detailed-terms-jo" id="section3">
            <p>
              ...
              <br />
              회사는 약관의 개정이 필요할 경우, 관련 법령에 따라 약관을 개정할 수 있습니다. 변경 사항은 ...
            </p>
          </div>
          <div className="detailed-terms-jo" id="section4">
            <p>
              <strong>제 4조 (약관 외 준칙)</strong>
              <br />이 약관에 명시되지 않은 사항에 대해서는 관련 법령 또는 회사의 운영 방침에 따릅니다.
            </p>
          </div>
        </div>
        ...
        <div className="detailed-terms-jang">
          ...
          <div className="detailed-terms-jo-head" id="section5">
            <p>
              ...
              <br />
              이용자는 회사가 정한 가입 양식에 따라 회원정보를 기입한 후 회원가입을 신청할 수 있으며, 회사는 이를 승인하여 이용계약이 체결됩니다.
            </p>
          </div>
          <div className="detailed-terms-jo" id="section6">
            <p>
              ...
              <br />
              기본적인 서비스는 무료로 제공되나, 특정 유료 서비스의 경우 이용요금이 발생할 수 있습니다.
            </p>
          </div>
          <div className="detailed-terms-jo" id="section7">
            <p>
              ...
              <br />
              회사는 서비스 제공을 위하여 이용자의 개인정보를 수집할 수 있으며, 이에 대한 자세한 사항은 개인정보 처리방침에 따릅니다.
            </p>
          </div>
          <div className="detailed-terms-jo" id="section8">
            <p>
              ...
              <br />
              이용자는 자신의 ID와 비밀번호 관리에 대한 책임이 있으며, 이를 소홀히 하여 발생한 손해에 대한 책임은 이용자에게 있습니다.
            </p>
          </div>
          <div className="detailed-terms-jo" id="section9">
            <p>
              ...
              <br />
              회사는 정기점검, 기술적 문제 등이 발생하는 경우 서비스 제공을 일시적으로 중단할 수 있습니다.
            </p>
          </div>
        </div>
        ...
        <div className="detailed-terms-jang">
          ...
          <div className="detailed-terms-jo-head" id="section10">
            <p>
              ...
              <br />
              이용자는 본 약관 및 회사의 운영 방침을 준수하여야 하며, 불법 행위를 하지 않아야 합니다.
            </p>
          </div>
          <div className="detailed-terms-jo" id="section11">
            <p>
              ...
              <br />
              회사가 제공하는 콘텐츠의 저작권은 회사에 있으며, 이용자는 이를 무단으로 복제, 배포할 수 없습니다.
            </p>
          </div>
          <div className="detailed-terms-jo" id="section12">
            <p>
              ...
              <br />
              회사는 일정한 사유가 발생할 경우, 서비스의 제공을 일시 중단할 수 있으며, 이 경우 사전 공지를 하여야 합니다.
            </p>
          </div>
        </div>
        ...
        <div className="detailed-terms-jang">
          ...
          <div className="detailed-terms-jo-head" id="section13">
            <p>
              ...
              <br />이 약관과 관련된 분쟁이 발생할 경우, 회사와 이용자는 상호 합의하여 해결하도록 노력합니다.
            </p>
          </div>
          <div className="detailed-terms-jo" id="section14">
            <p>
              <strong>제 14조 (관할법원)</strong>
              <br />이 약관에 의한 서비스 이용과 관련된 소송은 회사의 본사 소재지를 관할하는 법원을 관할 법원으로 합니다.
            </p>
          </div>
        </div>
      </div>
